...
- Own task launch, state and memory curation, history ledgers, commits, and Kaggle submissions.
...
- Launch one bounded scientist batch or one bounded analyst yes/no question per wake unless the current stage explicitly requires more.
